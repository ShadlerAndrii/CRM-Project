    ...
    methods: {
        createAccount() {
            if (!this.email || !this.password || !this.surname || !this.name || !this.phone || !this.birthday || !this.sex || !this.role) {
                ...
                return; // Зупиняє виконання методу, якщо хоча б одне поле порожнє
            }
